...
src_prepare() {
	...
	# declaration of ghostscript errors changed
	# ref: http://lists.linuxfromscratch.org/pipermail/blfs-book/2015-October/056960.html
	if use postscript && has_version '>=app-text/ghostscript-gpl-9.18' ; then
		sed -e 's/ e_/ gs_error_/' \
			-i plugin/gs/gvloadimage_gs.c || die
	fi
